...
**Live:** the dashboard is deployed at [prlens.ismailmechkene.dev](https://prlens.ismailmechkene.dev/), backed by the FastAPI server on [Railway](https://railway.app/) and Postgres on [Supabase](https://supabase.com/).
